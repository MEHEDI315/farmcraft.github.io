                ...
                <div class="bd-sidebar__widget-warpper mb-60">
                   <div class="bd-product__filters">
                      <div class="bd-filter__widget child-content-hidden">
                         ...
                         <h4 class="bd-filter__widget-title drop-btn"><?php echo e($category_name); ?></h4>
                         <div class="bd-filter__content">
                            <div class="bd-product__check">
                               <ul>
                                  ...
                                  <li> 
                                        <a href="<?php echo e(route('product.category',['category_slug'=>$category->slug])); ?>" class="check-input" type="checkbox" id="s-01"> 
                                            <label class="check-label" for="s-01"><?php echo e($category->name); ?></label></a>
                                  </li>
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div class="bd-trending__item text-center mb-30">
                                           ...
                                           <div class="bd-trending__product-thumb border-5">
                                              <a href="<?php echo e(route('product.details',['slug'=>$product->slug])); ?>"><img
                                                    src="<?php echo e(asset('assets/img/product')); ?>/<?php echo e($product->image); ?>"
                                              ...
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal" wire:click.prevent="store(<?php echo e($product->id); ?>,'<?php echo e($product->name); ?>',<?php echo e($product->regular_price); ?>)">
                                           ...
                                           <div class="bd-trending__content">
                                              <h4 class="bd-product__title"><a href="product-details.html"><?php echo e($product->name); ?></a></h4>
                                              <div class="bd-product__price">
                                                 <span class="bd-product__old-price"><del>$<?php echo e($product->regular_price); ?></del></span><span
 ...
 <!-- Footer area start -->
<?php /**PATH C:\xampp\htdocs\wworganic\resources\views/livewire/category-component.blade.php ENDPATH**/ ?>