                                 ...
                                 <ul>
                                    ...
                                    <li>
                                          ...
                                          <a href="<?php echo e(route('product.category',['category_slug'=>$category->slug])); ?>"  class="check-input" type="checkbox" id="s-01">
                                             <label class="check-label" for="s-01"><?php echo e($category->name); ?></label>
                                    </a>
                                    </li>
                        ...
                        <div class="bd-filter__tab-inner mb-30">
                           ...
                           <div class="bd-sort__type-filter" >
                              <select class="sorting-list" name="sorting-list" wire.model="sorting">
                                 ...
                                 <option value="price">Newly published</option>
   ...
   <!-- Footer area start -->
  <?php /**PATH C:\xampp\htdocs\wworganic\resources\views/livewire/shop-component.blade.php ENDPATH**/ ?>