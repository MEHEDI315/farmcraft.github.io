<main>
             ...
             <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="bd-about__wrapper mb-60">
                   <div class="bd-about__image-1 m-img mb-60">
                      <img src="<?php echo e(asset('assets/img/about/about-img-3.jpg')); ?>" alt="about-image">
                   </div>
                   <div class="bd-about__image-2 m-img">
                      <img src="<?php echo e(asset('assets/img/about/about-img-4.jpg')); ?>" alt="about-image">
                   </div>
                </div>
             </div>
                ...
                <div class="bd-about__content-box mb-60">
                   ...
                   <div class="bd-about__inner">
                      <div class="bd-about__image-3">
                         <img src="<?php echo e(asset('assets/img/about/about-img-5.jpg')); ?>" alt="about-imgage">
                      </div>
                      <div class="bd-about__info">
                         <p>We had reached a great height in the atmosphere, for the sky was a dead black, and the
                            stars had ceased to twinkle. By the same illusion which lifts the horizon of the sea to
                            the level. Always be able to find the phone that you are looking for in our offer, have
                            made us stand out in the market, but they are simply symptoms of our dedication to what we
                            are doing and our desire to constantly.</p>
                   ...
                   <div class="bd-testimonial-active swiper-container">
                      <div class="swiper-wrapper">
                         <div class="swiper-slide">
                            <div class="bd-testimonial__wrapper text-center">
                               <div class="bd-testimonial__thumb">
                                  <img src="<?php echo e(asset('assets/img/testimonial/testimonial-1.png')); ?>" alt="testimonial-image">
                               </div>
                         ...
                         <div class="swiper-slide">
                            <div class="bd-testimonial__wrapper text-center">
                               <div class="bd-testimonial__thumb">
                                  <img src="<?php echo e(asset('assets/img/testimonial/testimonial-2.png')); ?>" alt="testimonial-image">
                               </div>
                               <div class="bd-testimonial__content">
                                  <p>Buying a package usually means you buy two or more services, with each service
                                     coming at a discounted price. For example, instead of buying a manicure for combo
       ...
       <div class="container">
          ...
          <div class="row">
             <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="bd-team__wrapper text-center mb-30">
                   <div class="bd-team__thumb w-img p-relative">
                      <a href="team-details.html"><img src="<?php echo e(asset('assets/img/team/team-thumb-01.jpg')); ?>" alt="team-thumb"></a>
             ...
             <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="bd-team__wrapper text-center  mb-30">
                   <div class="bd-team__thumb w-img p-relative">
                      <a href="team-details.html"><img src="<?php echo e(asset('assets/img/team/team-thumb-02.jpg')); ?>" alt="team-thumb"></a>
                      <div class="bd-content__inner">
                         <div class="bd-team__share">
                            <a href="team-details.html"><i class="fa-light fa-share-nodes"></i></a>
                            <div class="bd-team__action">
             ...
             <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="bd-team__wrapper text-center  mb-30">
                   <div class="bd-team__thumb w-img p-relative">
                      <a href="team-details.html"><img src="<?php echo e(asset('assets/img/team/team-thumb-03.jpg')); ?>" alt="team-thumb"></a>
                      <div class="bd-content__inner">
                         <div class="bd-team__share">
                            <a href="team-details.html"><i class="fa-light fa-share-nodes"></i></a>
                            <div class="bd-team__action">
             ...
             <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="bd-team__wrapper text-center  mb-30">
                   <div class="bd-team__thumb w-img p-relative">
                      <a href="team-details.html"><img src="<?php echo e(asset('assets/img/team/team-thumb-04.jpg')); ?>" alt="team-thumb"></a>
                      <div class="bd-content__inner">
                         <div class="bd-team__share">
    ...
    <!-- Team-area-end -->
 </main><?php /**PATH C:\xampp\htdocs\wworganic\resources\views/livewire/about-component.blade.php ENDPATH**/ ?>