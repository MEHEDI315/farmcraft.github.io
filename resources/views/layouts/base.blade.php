                        ...
                        <div class="bd-action__item">
                           ...
                           <div class="bd-action__cart">
                              <div class="bd-action__cart-icon">
                                 ...
                                 @if (Cart::count() > 0)
                                 <span class="bd-action__item-number cart-count">{{ Cart::count()}}</span>
                                 @endif
                              </div>
                           </div>
                        </div>
                                    ...
                                    <div class="product-details-active swiper-container">
                                       <div class="swiper-wrapper">
                                          ...
                                          <div class="swiper-slide">
                                             <div class="bd-product__details-large-img w-img">
                                                <a href="img/product/1.html" data-rel="lightcase:myCollection">
                                                   <img src="{{ asset('assets/img/product/details/2.png')}}" alt="product-details-img">
                                                </a>
                                             </div>
                                          </div>
                                          <div class="swiper-slide">
                                       ...
                                       <div class="swiper-wrapper">
                                          <div class="swiper-slide m-img">
                                             <div class="product-small__img">
                                                <img src="{{ asset('assets/img/product/details/1.png')}}" alt="product-thumb">
                                             </div>
                                          </div>
                                          <div class="swiper-slide m-img">
                                             <div class="product-small__img">
                                                <img src="{{ asset('assets/img/product/details/2.png')}}" alt="product-thumb">
                                             </div>
                                          </div>
                                          <div class="swiper-slide m-img">
                                             <div class="product-small__img">
                                                <img src="{{ asset('assets/img/product/details/3.png')}}" alt="product-thumb">
                                             </div>
                                          </div>
                                          <div class="swiper-slide m-img">
                                             <div class="product-small__img">
                                                <img src="{{ asset('assets/img/product/details/4.png')}}" alt="product-thumb">
                                             </div>
                                          </div>
                                          <div class="swiper-slide m-img">
                                             <div class="product-small__img">
                                                <img src="{{ asset('assets/img/product/details/5.png')}}" alt="product-thumb">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                           ...
                           <div class="col-md-6">
                              <div class="modal-product-info modal-product__details-content">
                                 ...
                                 <div class="bd__safe-checkout">
                                    ...
                                    <a href="#"><img src="{{ asset('assets/img/icon/discover.png')}}" alt="Payment Image"></a>
                                    <a href="#"><img src="{{ asset('assets/img/icon/mastercard.png')}}" alt="Payment Image"></a>
                                    <a href="#"><img src="{{ asset('assets/img/icon/paypal.png')}}" alt="Payment Image"></a>
                                    <a href="#"><img src="{{ asset('assets/img/icon/visa.png')}}" alt="Payment Image"></a>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="cartmini__inner">
               <ul>
                  <li>
                     <div class="cartmini__thumb">
                        <a href="product-details.html">
                           <img src="{{ asset('assets/img/trending/populer-item/populer-thumb-01.png')}}" alt="product image">
                        </a>
                     </div>
                  ...
                  <li>
                     <div class="cartmini__thumb">
                        <a href="product-details.html">
                           <img src="{{ asset('assets/img/trending/populer-item/populer-thumb-02.png')}}" alt="product image">
                        </a>
                     </div>
                     <div class="cartmini__content">
                  ...
                  <li>
                     <div class="cartmini__thumb">
                        <a href="product-details.html">
                           <img src="{{ asset('assets/img/trending/populer-item/populer-thumb-05.png')}}" alt="product image">
                        </a>
                     </div>
                     <div class="cartmini__content">
                           ...
                           <div class="bd-header__left-2">
                              <div class="bd-header__logo-2 p-relative">
                                 <a href="index.html">
                                    ...
                                    <img class="logo-black" src="{{ asset ('assets/img/logo/logo-2.png')}}" alt="logo">
                                 </a>
                                    ...
                                    <ul>
                                       ...
                                       @if (Route::has('login'))
                                         @auth
                                            ...
                                            <li class="has-dropdown">
                                                 <a title = "My Acount "href="#">My Account({{ Auth::user()->name}})</a>
                                                  <ul class="submenu">
                                                   <li><a tittle = "Dashboard" href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                                   <li><a tittle = "Logout" href="{{ route('admin.dashboard') }}" onclick="event.preventDefault();
                                          ...
                                          <ul class="submenu">
                                             ...
                                             <li><a title = "Logout" href="{{ route('admin.dashboard') }}" onclick="event.preventDefault();
                                             getElementById('logout-form').submit();">Logout</a></li>
                                 ...
                                 <div class="bd-action__item">
                                    ...
                                    <div class="bd-action__cart">
                                       <div class="bd-action__cart-icon">
                                          ...
                                          @if (Cart::count() > 0)
                                          <span class="bd-action__item-number ">{{Cart::count()}}</span>
                                          @endif
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="bd-action__hotline d-none d-xl-block">
                                 <div class="bd-hotline__inner">
                                    <div class="bd-hotline__icon">
                                       <img src="{{ asset('assets/img/icon/action-hotline.png')}}" alt="hotline-icon">
                                    </div>
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="bd-footer__payment">
                     <ul>
                        ...
                        <li><a href="#"><img src="{{ asset('assets/img/icon/mastercard.png')}}" alt="mastercard"></a></li>
