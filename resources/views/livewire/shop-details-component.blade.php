                                  ...
                                  <div class="swiper-wrapper">
                                     <div class="swiper-slide">
                                        <div class="bd-product__details-large-img w-img">
                                           <img src="{{ asset('assets/img/trending/product') }}/{{ $product->image }}" alt="{{ $product->name }}">
                                        </div>
                                     </div>
                                    ...
                                    @foreach ($popular_product as $p_product)
                                     <div class="swiper-slide m-img">
                                        <div class="product-small__img">
                                          <a href="{{ route('product.details',['slug'=>$p_product->slug])}}"></a>
                                           <img src="{{ asset('assets/img/product/details')}}/{{ $p_product->image }}" alt="{{ $p_product->name }}">
                                        </div>
                                     </div>
                                     @endforeach
                                  </div>
                      ...
                      <div class="col-md-6">
                         <div class="modal-product-info shop-details-info">
                            ...
                            <div class="product-quantity-cart mb-25">
                               ...
                               <a class="cart-btn bd-fill__btn" href="{{ route('product.details',['slug'=>$product->slug])}}" data-toggle="tooltip"
                                  data-placement="top" title="Add to Cart" data-bs-toggle="modal" wire:click.prevent="store({{ $product->id}},'{{$product->name}}',{{ $product->regular_price }})"><i
                         ...
                         <div class="tabs-wrapper mt-35 mb-50">
                            <div class="course-review-item mb-30">
                               <div class="course-reviews-img">
                                  <a href="#"><img src="{{ asset('assets/img/testimonial/1.jpg')}}" alt="image not found"></a>
                               </div>
                            ...
                            <div class="course-review-item mb-30">
                               <div class="course-reviews-img">
                                  <a href="#"><img src="{{ asset('assets/img/testimonial/2.jpg')}}" alt="image not found"></a>
                               </div>
                               <div class="course-review-list">
                            ...
                            <div class="course-review-item mb-30">
                               <div class="course-reviews-img">
                                  <a href="#"><img src="{{ asset('assets/img/testimonial/3.jpg')}}" alt="image not found"></a>
                               </div>
                               <div class="course-review-list">
                               ...
                               <div class="bd-trending__item text-center mb-30">
                                  <div class="bd-trending__product-thumb">
                                     <a href="{{ route('product.details',['slug'=>$r_product->slug])}}">
                                       <img
                                           src="{{ asset('assets/img/trending/fruits') }}/{{ $r_product->image }}" alt="{{ $r_product->name }}">
                                          </a>
                                  ...
                                  <div class="bd-teanding__content">
                                     <h4 class="bd-product__title"><a href="{{ route('product.details',['slug'=>$r_product->slug])}}">{{$r_product->name}}</a></h4>
                                     <div class="bd-product__price">
                                        <span class="bd-product__old-price"><del>${{ $r_product->regular_price }}</del></span><span
