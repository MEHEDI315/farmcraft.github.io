<main>
    ...
    <!-- Faq area start -->
    <section class="bd-faq__area pt-110 pb-95">
       <div class="container small-container">
          <div class="row">
             <div class="col-lg-6">
                <div class="bd-faq__wrapper mb-30">
             ...
             <div class="col-lg-6">
                <div class="bd-faq__wrapper-2 mb-30">
                   <div class="bd-faq__accordion" data-aos="fade-left" data-aos-duration="1000">
    ...
    <!-- Faq-from-area-start -->
    <div class="bd__faq-from-area pb-100">
       <div class="container small-container">
          <div class="row">
             <div class="col-12">
                <div class="bd-section__title-wrapper text-center mb-60">
                   <h2 class="bd-section__title mb-30">Still stuck ask directly</h2>
                </div>
             </div>
          </div>
          <div class="row justify-content-center">
             <div class="col-xl-8 col-lg-10">
                <div class="bd-postbox__contact mb-30">
                   <form action="#">
                      <div class="row">
                      ...
                      <div class="col-xxl-12">
                         <div class="bd-postbox__btn">
                            <button type="submit" class="bd-fill__btn">Post Comment</button>
                         </div>
                      </div>
                   </form>
                </div>
