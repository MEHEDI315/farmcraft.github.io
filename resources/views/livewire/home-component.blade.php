                            ...
                            <div class="bd-banner__content">
                               ...
                               <div class="bd-banner__button">
                                  <div class="bd-button__inner">
                                     <a class="bd-bn__btn-1" href="/shop">Shop Now</a>
                                  </div>
    ...
    <section class="bd-about__area grey-bg p-relative z-index-1 pt-130 pb-70">
       <div class="container">
          <div class="bd-about__bg-wrapper p-relative">
             <img class="bd-about__bg-shape " src="{{ asset('assets/img/about/about-big-shape.png')}}" alt="about-big-shape">
          </div>
                ...
                <div class="bd-about__content-wrapper mb-60">
                   ...
                   <div class="bd-about__content">
                      ...
                      <div class="bd-about__action">
                         <a class="bd-bn__btn-1" href="/about">About Us</a>
                      </div>
                   </div>
                </div>
             </div>
          ...
          <div class="row">
             <div class="col-12">
                <div class="bd-section__title-wrapper text-center mb-60">
                   ...
                   <h2 class="bd-section__title mb-30">News From FarmCraft</h2>
                </div>
             </div>
          </div>
          <div class="row">
             <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="bd-news__item mb-60">
                   <div class="bd-news__thumb w-img">
                      <a href="/news"><img src="{{ asset('assets/img/news/news-thumb-01.jpg')}}" alt="news-image"></a>
                   </div>
                   <div class="bd-news__content">
                      ...
                      <div class="bd-news__title">
                         <h3><a href="/news">Worthy Cyber Monday Organic Food
                               From Foodpond</a></h3>
                      </div>
                      <a class="bd-news__btn" href="/news">Read More<span><i
             ...
             <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="bd-news__item mb-60">
                   <div class="bd-news__thumb w-img">
                      <a href="/news"><img src="{{ asset('assets/img/news/news-thumb-02.jpg')}}" alt="news-image"></a>
                   </div>
                   <div class="bd-news__content">
                      <div class="bd-news__meta-list">
                         <div class="bd-news__meta-item">
                      ...
                      <div class="bd-news__title">
                         <h3><a href="/news">Holiday Home Delivery We have
             ...
             <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="bd-news__item mb-60">
                   <div class="bd-news__thumb w-img">
                      <a href="/news"><img src="{{ asset('assets/img/news/news-thumb-03.jpg')}}" alt="news-image"></a>
                   </div>
                   <div class="bd-news__content">
                      <div class="bd-news__meta-list">
                         <div class="bd-news__meta-item">
                      ...
                      <div class="bd-news__title">
                         <h3><a href="/news">Unique Ideas for Healthy Food You
